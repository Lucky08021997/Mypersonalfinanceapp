...
interface ConfirmTrashAccountModalProps {
    accountName: string;
    onClose: (e: React.MouseEvent) => void;
    onConfirm: () => void;
}

const ConfirmTrashAccountModal: React.FC<ConfirmTrashAccountModalProps> = ({ accountName, onClose, onConfirm }) => {
                    ...
                    <div className="flex items-start">
                        ...
                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 className="text-lg leading-6 font-bold text-gray-900 dark:text-gray-100" id="modal-title">
                                Move "{accountName}" to Trash?
                            </h3>
                            <div className="mt-2">
                                <p className="text-sm text-gray-500 dark:text-gray-400">
                                    This closed loan will be moved to Trash and permanently deleted after 7 days. Do you want to continue?
                                </p>
                            </div>
                        </div>
                    </div>
...
export default ConfirmTrashAccountModal;